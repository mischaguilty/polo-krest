        ...
        <div class="content">
                    ...
                    <div class="col-lg-7">
                        <div class="product-description">
                            <div class="product-title">
                                <h3>
                                    <a href="{{ route('services.show', [slug($serviceGroup->name)]) }}">{{ $serviceGroup->name }}</a>
                                </h3>
                            </div>
            ...
            <div class="widget-shop">
                <div class="d-inline-flex justify-content-between">
                    @forelse(\App\Models\ServiceGroup::query()->whereNotIn('id', [$serviceGroup->id])->inRandomOrder()->take(4)->get() as $product)
                        <div class="product">
                            <div class="product-image">
                                <a href="{{ route('services.show', [slug($product->name)]) }}">
